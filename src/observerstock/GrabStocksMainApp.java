...
public class GrabStocksMainApp{
	...
	public static void main(String[] args){
		...
		stockGrabber.setIBMPrice(1197.00);
		stockGrabber.setAAPLPrice(1677.60);
		stockGrabber.setGOOGPrice(1676.40);
		
		StockObserver observer3 = new StockObserver(stockGrabber);
		
		stockGrabber.setIBMPrice(11197.00);
		stockGrabber.setAAPLPrice(11677.60);
		stockGrabber.setGOOGPrice(11676.40);
