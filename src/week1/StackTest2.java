package week1;
// Fig 20.10: StackTest2.java; passing generic Stack objects to generic methods
public class StackTest2
{
	...
	public static <T> void testPush(String name , Stack<T> stack, T[] elements)	// String name, Stack<T> stack, T[] elements
	{
	...
	public static <T> void testPop(String name, Stack<T> stack)
	{
		...
		try
		{
			...
			T popValue;		// store elements removed from stack
