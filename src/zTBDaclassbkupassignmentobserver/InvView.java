...
//		System.out.println(theModel.listInventoryView);
		System.out.println(theModel.getListInventoryView());
...
//		System.out.println(InvModel.listInventoryView);
		...
		// for removing "static" from model, need to create get methods, 
...
//			    System.out.println(theModel.listInventoryView);
        	...
        	case DVD : 
        		...
        		theController.getInventoryList();
//			    System.out.println(theModel.listInventoryView);
			    System.out.println(theModel.getListInventoryView());        	break;
        	case BOOKS : 
