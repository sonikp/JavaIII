package week7;
// fig 23.18 // Synchronized access to a shared three-element bounded buffer (BB)

public class BB_CircularBuffer implements BB_Buffer
{
	...
	{
		// wait until buffer has space available, the write value; while no empty locations, place thread in blocked state
	...
	{
		// wait until buffer has data, then read value; while no data to read, place thread in a waiting state
	...
	{
		// outout operation and number of occupied buffer cells
